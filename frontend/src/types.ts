...
export type ApplicationDiscoveryWorkspace = { task: ApplicationDiscoveryTask; queries: ApplicationDiscoveryQuery[]; matches: { id: string; customer_lead_id: string; tds_application_id?: string | null; match_status: string; matching_reason?: string | null; pending_confirmation?: string | null; evidence_strength: number }[]; leads: CustomerLead[] }
