...
function CustomerDrawer({customer,projects,quotes,followups,products,emails,tasks,timelineEvents,close,addFollowup,addQuote,updateStage,editCustomer,openEmail}:{customer:Customer;projects:Project[];quotes:Quote[];followups:Followup[];products:Product[];emails:MailEmail[];tasks:Task[];timelineEvents:TimelineEvent[];close:()=>void;addFollowup:()=>void;addQuote:()=>void;updateStage:(customer:Customer,stage:CustomerStage)=>Promise<void>;editCustomer:()=>void;openEmail:(email:MailEmail)=>void}) {
