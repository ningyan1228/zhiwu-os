...
export const tdsDiscoveryPresets: TdsDiscoveryPreset[] = [
  {
    ...
    task: {
      ...
      application_keywords: ['water based flexographic inks', 'water based printing inks', 'BOPP films', 'OPP films', 'polypropylene coatings', 'waterborne primers'],
  ...
  },
  {
    ...
    task: {
      ...
      application_keywords: ['flexible PVC compounds', 'PVC cable compounds', 'PVC films and sheets', 'PVC artificial leather', 'PVC flooring', 'industrial sealants'],
